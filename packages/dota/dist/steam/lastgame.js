...
export default async function lastgame({ locale, steam32Id, currentMatchId, currentPlayers, }) {
    ...
    try {
        ...
        const totalPlayers = playersFromLastGame.length > 1
            ? t('lastgame.total', {
                lng: locale,
...
//# sourceMappingURL=lastgame.js.map