...
export function toggleDoubledownMmr({ currentMmr, isParty, didWin, wasDoubledown }) {
...
commandHandler.registerCommand('fixdbl', {
    ...
    handler: async (message, args) => {
        ...
        chatClient.say(message.channel.name, t('toggleMatch', {
...
//# sourceMappingURL=fixdbl.js.map