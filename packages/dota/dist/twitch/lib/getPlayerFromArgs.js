...
export async function getPlayerFromArgs({ args, locale, packet, command, }) {
    ...
    if (!args.length) {
        ...
        throw new CustomError(t('invalidColorNew', { command, colorList: heroColors.join(' · '), lng: locale }));
    }
    // herokey is 0-9
    let playerIdx;
...
//# sourceMappingURL=getPlayerFromArgs.js.map