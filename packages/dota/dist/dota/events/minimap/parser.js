...
class MinimapParser {
    ...
    isGameOnGoing(mapData) {
        return (mapData &&
            ['DOTA_GAMERULES_STATE_GAME_IN_PROGRESS', 'DOTA_GAMERULES_STATE_PRE_GAME'].includes(mapData.game_state));
    }
    isGamePaused(mapData) {
