...
import { checkForInactiveTokens, TOKEN_TIMEOUT, tokenLastPostTimestamps, } from './clearCacheForUser.js';
...
class GSIServer {
    ...
    constructor() {
        ...
        app.post('/', (req, res, next) => {
            ...
            next();
        }, validateToken, processChanges('previously'), processChanges('added'), newData);
        app.get('/', (req, res) => {
...
//# sourceMappingURL=GSIServer.js.map