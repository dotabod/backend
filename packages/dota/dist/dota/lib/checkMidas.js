...
async function checkMidasIterator(client) {
    ...
    const passiveMidasData = (await redisClient.client.json.get(`${token}:passiveMidas`)) || {
    ...
    if (midasCharges === 2 && !passiveMidasData.told && !passiveMidasData.firstNoticedPassive) {
        ...
        const secondsToUse = Math.round((Date.now() - passiveMidasData.told + passiveMidasThreshold) / 1000);
...
//# sourceMappingURL=checkMidas.js.map