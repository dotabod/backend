...
export const formatTranslatedSpeakerLabel = function formatTranslatedSpeakerLabel(
  heroName: string,
  playerId: number,
  locale: string
): string {
...
export const resolveTranslatedHeroName = function resolveTranslatedHeroName(params: {
  heroName: string
  playerId: number
...
export const formatTranslatedInGameChatMessage = function formatTranslatedInGameChatMessage(
  message: string,
  locale: string
): string {
...
const isWithinTranslatedLimit = function isWithinTranslatedLimit(
  message: string,
  locale: string,
  maxLength: number
): boolean {
...
const truncateToLimit = function truncateToLimit(
  message: string,
  locale: string,
  maxLength: number
): string {
...
export const formatTranslatedInGameChatMessages = function formatTranslatedInGameChatMessages(
