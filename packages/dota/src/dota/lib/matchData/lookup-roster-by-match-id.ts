import { extractPlayersFromMongoDoc, fetchDelayedGameDoc } from './internal/mongo-doc'
...
export const lookupRosterByMatchId = async function lookupRosterByMatchId(
  matchId: string
  ...
  return { accountIds, matchPlayers: players }
}
