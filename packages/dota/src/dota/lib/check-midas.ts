...
export const checkPassiveMidas = async function checkPassiveMidas(client: SocketClient) {
...
const checkMidasIterator = async function checkMidasIterator(client: SocketClient) {
