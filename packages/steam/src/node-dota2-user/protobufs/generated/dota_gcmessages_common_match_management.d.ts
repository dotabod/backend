...
export declare const CSODOTAPartyMember: MessageFns<CSODOTAPartyMember>;
export declare const CSODOTAParty: MessageFns<CSODOTAParty>;
export declare const CSODOTAPartyInvite: MessageFns<CSODOTAPartyInvite>;
export declare const CSODOTAPartyInvite_PartyMember: MessageFns<CSODOTAPartyInvite_PartyMember>;
export declare const CMsgLeaverState: MessageFns<CMsgLeaverState>;
export declare const CMsgReadyCheckStatus: MessageFns<CMsgReadyCheckStatus>;
export declare const CMsgReadyCheckStatus_ReadyMember: MessageFns<CMsgReadyCheckStatus_ReadyMember>;
export declare const CMsgPartyReadyCheckRequest: MessageFns<CMsgPartyReadyCheckRequest>;
export declare const CMsgPartyReadyCheckResponse: MessageFns<CMsgPartyReadyCheckResponse>;
export declare const CMsgPartyReadyCheckAcknowledge: MessageFns<CMsgPartyReadyCheckAcknowledge>;
export declare const CMsgLobbyEventGameDetails: MessageFns<CMsgLobbyEventGameDetails>;
export declare const CMsgMatchMatchmakingStats: MessageFns<CMsgMatchMatchmakingStats>;
export declare const CMvpData: MessageFns<CMvpData>;
export declare const CMvpData_MvpDatum: MessageFns<CMvpData_MvpDatum>;
export declare const CMvpData_MvpDatum_MvpAccolade: MessageFns<CMvpData_MvpDatum_MvpAccolade>;
...
export {};
//# sourceMappingURL=dota_gcmessages_common_match_management.d.ts.map