export declare enum EDOTAGCMsg {
...
export declare function eDOTAGCMsgFromJSON(object: any): EDOTAGCMsg;
export declare function eDOTAGCMsgToJSON(object: EDOTAGCMsg): string;
//# sourceMappingURL=dota_gcmessages_msgid.d.ts.map