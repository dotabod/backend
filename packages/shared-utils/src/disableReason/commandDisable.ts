...
export const commandDisable = {
  ...
  async disable(
    ...
    return await trackDisableReason(userId, 'commandDisable', reason, metadata, { disabledValue: true })
  },
  ...
  async enable(
    ...
    return await trackResolveReason(userId, 'commandDisable', opts.autoResolved ?? false, {
      enabledValue: false,
      reason: opts.reason,
    })
  },
  ...
  async recordNotification(
    ...
    return await recordDisableNotification(userId, 'commandDisable', reason, metadata)
  },
}
