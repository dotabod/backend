...
import russianWords from '../../wordlists/russian.json' with { type: 'json' }
import chineseWords from '../../wordlists/chinese.json' with { type: 'json' }
import spanishWords from '../../wordlists/spanish.json' with { type: 'json' }
import frenchWords from '../../wordlists/french.json' with { type: 'json' }
import germanWords from '../../wordlists/german.json' with { type: 'json' }
import spanishLeetWords from '../../wordlists/spanish-leetspeak.json' with { type: 'json' }
